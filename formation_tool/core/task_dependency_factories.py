...
def build_task_preflight_deps(module):
    ...
    return SimpleNamespace(
        ...
        get_demo_group_weight_rules=lambda: runtime_state.demo_group_weight_rules,
        ...
        build_demo_group_weight_generation_context=module.build_demo_group_weight_generation_context,
