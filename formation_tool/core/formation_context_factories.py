...
def build_sampling_core_context(runtime, deps):
    ...
    return SimpleNamespace(
        ...
        SAMPLING_TEMP_DB=runtime.sampling_temp_db,
        SAMPLING_INCREMENT_DB=runtime.sampling_increment_db,
        ...
        interruptible_sleep=deps.interruptible_sleep,
...
def build_group_weight_builder_context(runtime, constants, deps):
    ...
    return SimpleNamespace(
        ...
        GROUP_WEIGHT_GROUP_RULES=getattr(runtime, 'group_weight_group_rules', {}),
        ZERO_REBATE_INFERENCE_MODES=getattr(runtime, 'zero_rebate_inference_modes', set()),
        INDEPENDENT_RTP_MODES=getattr(runtime, 'independent_rtp_modes', set()),
